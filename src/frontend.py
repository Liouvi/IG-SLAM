...
class Frontend:
    ...
    def __update(self):
        ...
        if d.item() < self.keyframe_thresh:
            ...
            if self.enable_loop and cur_t > self.frontend_window:
                n_kf, n_edge = self.loop_closing.loop_ba(t_start=t_start, t_end=cur_t, steps=self.iters2, motion_only=False, local_graph=self.graph)
    ...
    def __initialize(self):
        ...
        for itr in range(8):
            self.graph.update(t0=0, t1=None, use_inactive=True)
