...
class FactorGraph:
    ...
    @torch.cuda.amp.autocast(enabled=True)
    def update(self, t0=None, t1=None, iters=2, use_inactive=False, EPS=1e-7, motion_only=False,fill=False):
        ...
        with torch.cuda.amp.autocast(enabled=True):
            ...
            self.video.ba(target, weight, damping, ii, jj, t0=t0, t1=t1,
                          iters=iters, lm=1e-4, ep=0.1, motion_only=motion_only,fill=fill, ba_type=None)
    ...
    def update_lowmem(self, t0=None, t1=None, iters=2, use_inactive=False, EPS=1e-7, steps=8, max_t=None, ba_type='dense', motion_only=False):
        ...
        for step in range(steps):
            ...
            if ba_type == 'loop':
                ...
                self.video.gba(target, weight, damping, self.ii, self.jj, t0=t0, t1=t1,
                              iters=iters, lm=1e-4, ep=1e-1, motion_only=motion_only, ba_type=ba_type)
